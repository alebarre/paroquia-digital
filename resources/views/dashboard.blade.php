...
<div class="stats-grid">
    <div class="stat-card">
        <div class="stat-icon text-blue-500"><i class="fa-solid fa-users"></i></div>
        <div>
    ...
    <div class="stat-card" style="border-left-color: #2563eb;">
        <div class="stat-icon text-blue-600"><i class="fa-solid fa-cross"></i></div>
        <div>
    ...
    <div class="stat-card" style="border-left-color: #16a34a;">
        <div class="stat-icon text-green-600"><i class="fa-solid fa-people-group"></i></div>
        <div>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title"><i class="fa-solid fa-calendar-days text-blue-500 mr-2"></i> Próximos Eventos</div>
            <a href="{{ route('eventos.create') }}" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Novo
                Evento</a>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title"><i class="fa-solid fa-cake-candles text-pink-500 mr-2"></i> Aniversariantes da
                Semana</div>
        </div>
        ...
        <div
            ...
            <a href="{{ route('fieis.show', $fiel) }}" class="btn btn-outline btn-sm"><i class="fa-solid fa-eye"></i>
                Ver</a>
        </div>
        @empty
        <p style="color:#94a3b8; font-size:14px;">Nenhum aniversariante esta semana. <i
                class="fa-solid fa-face-smile text-yellow-500"></i></p>
        @endforelse
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title"><i class="fa-solid fa-file-invoice-dollar text-green-600 mr-2"></i> Financeiro — {{
                now()->translatedFormat('F Y') }}</div>
            <a href="{{ route('financas.index') }}" class="btn btn-outline btn-sm"><i class="fa-solid fa-eye"></i> Ver
                tudo</a>
        </div>
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-top:8px;">
            <div style="text-align:center; padding:16px; background:#f0fdf4; border-radius:10px;">
                <div style="font-size:20px; font-weight:700; color:#16a34a;">R$ {{ number_format($totalEntradas, 2, ',',
                    '.') }}</div>
                <div style="font-size:12px; color:#166534; margin-top:4px;"><i class="fa-solid fa-arrow-trend-up"></i>
                    Entradas</div>
            </div>
            <div style="text-align:center; padding:16px; background:#fef2f2; border-radius:10px;">
                <div style="font-size:20px; font-weight:700; color:#dc2626;">R$ {{ number_format($totalSaidas, 2, ',',
                    '.') }}</div>
                <div style="font-size:12px; color:#991b1b; margin-top:4px;"><i class="fa-solid fa-arrow-trend-down"></i>
                    Saídas</div>
            </div>
        </div>
        <a href="{{ route('financas.create') }}" class="btn btn-primary"
            style="margin-top:16px; width:100%; justify-content:center;"><i class="fa-solid fa-plus"></i> Registrar
            Lançamento</a>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title"><i class="fa-solid fa-cross text-blue-800 mr-2"></i> Sacramentos por Tipo</div>
            <a href="{{ route('sacramentos.index') }}" class="btn btn-outline btn-sm"><i class="fa-solid fa-eye"></i>
                Ver tudo</a>
        </div>
