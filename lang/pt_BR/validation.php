...
return [
    ...
    'declined_if' => 'O campo :attribute deve ser declinado quando :other for :value.',
    ...
    'required_if_declined' => 'O campo :attribute é obrigatório quando :other for declinado.',
